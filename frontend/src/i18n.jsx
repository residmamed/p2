...
const STRINGS = {
  en: {
    ...
    rtSortOpportunity: "Opportunity score",
    rtSortPerOz: "Price per oz",
    msPerOz: "Median $/oz",
    msPerOzOf: "of {n} sized",
    rtMin: "Min",
    rtMax: "Max",
  ...
  az: {
    ...
    rtSortOpportunity: "İmkan balı",
    rtSortPerOz: "Unsiya başına qiymət",
    msPerOz: "Median $/unsiya",
    msPerOzOf: "{n} ölçülü məhsuldan",
    rtMin: "Min",
    rtMax: "Maks",
